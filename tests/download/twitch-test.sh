...
DEBUG=get-attribute npx -y @localnerve/get-attribute --url=https://m.twitch.tv/gigaohmbiological/home --selector='a[href^="/videos"]' --attribute=href --useprop=true >$GIGAOHMBIO_URL
